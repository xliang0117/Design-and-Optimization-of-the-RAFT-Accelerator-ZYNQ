...
class BottleneckBlock(nn.Module):
    def __init__(self, in_planes, planes, norm_fn='batch', stride=1):
        ...
        self.conv1 = qnn.QuantConv2d(in_planes, planes//4, kernel_size=1, padding=0, input_quant=ActQuant, weight_quant=WeightQuant, bias_quant=BiasQuant, return_quant_tensor=True)
        self.depthconv2 = qnn.QuantConv2d(planes//4, planes//4, kernel_size=3, padding=1, stride=stride, input_quant=ActQuant, weight_quant=WeightQuant, bias_quant=BiasQuant, groups=planes//4, return_quant_tensor=True)
        self.pointconv2 = qnn.QuantConv2d(planes//4, planes//4, kernel_size=1, input_quant=ActQuant, weight_quant=WeightQuant, bias_quant=BiasQuant, return_quant_tensor=True)
        self.conv3 = qnn.QuantConv2d(planes//4, planes, kernel_size=1, padding=0, input_quant=ActQuant, weight_quant=WeightQuant, bias_quant=BiasQuant, return_quant_tensor=True)
