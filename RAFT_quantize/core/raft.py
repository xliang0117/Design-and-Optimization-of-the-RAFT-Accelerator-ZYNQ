...
class RAFT(nn.Module):
    def __init__(self, args):
        ...
        self.fnet = SmallEncoder(output_dim=128, norm_fn='batch', dropout=args.dropout)        
    ...
    def forward(self, image1, image2, iters=1, flow_init=None, upsample=True, test_mode=False):
