...
void load_fm_tile(ADT32 *ifm_ddr, hls::vector<ADT, 32> ifm[50][50], short rowx, short colx, short chx, short width, short height);
void load_fm_s2(ADT32 *ifm_ddr, hls::vector<ADT, 32> ifm[50][50], short rowx, short colx, short chx, short width, short height);
void load_fm_full(ADT32 *ifm_ddr, hls::vector<ADT, 32> ifm[50][50], short chx);
