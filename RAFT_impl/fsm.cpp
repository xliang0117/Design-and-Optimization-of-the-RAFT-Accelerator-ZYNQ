...
//EI1, 48*48*24 -> 48*48*24
    ...
    pw_conv_group(afm_1, rfm, wBUF1x1_A, 1);
    export_fm_full_withact(fm, 385, rfm, 1, pwb_buf, 7, true);
...
//EJ, 48*48*24 -> 48*48*96
    ...
    export_fm_full_withact(fm, 2689, rfm, 3, pwb_buf, 6, true);
...
//EK, 48*48*96 -> 48*48*64
    ...
    export_fm_full_withact(fm, 147841, rfm, 2, pwb_buf, 7, false);
...
//CJ, 48*48*24 -> 48*48*96
    ...
    pw_conv_group(afm_1, rfm, wBUF1x1_A, 3);
    export_fm_full_withact(fm, 2689, rfm, 3, pwb_buf, 5, true);
...
//CK2, 48*48*96 -> 48*48*64
    ...
    export_fm_full_withact(fm, 37249, rfm, 2, pwb_buf, 10, true);
...

{
    ...
    CORR_GEN:for (short group = 0; group < 24; group++)
    {
        ...
        export_corr(fm, 166273, rfm, group);
    }
...
for(short iter = 0; iter < 3; iter++) {
    ...
    {
        grid_sample_UPDATE(fm, flow, update, corr_buffer+layerNum*2304*8, layerNum);
...
//A, 48*48*196 -> 48*48*96
    ...
    export_fm_full_withact(fm, 16513, rfm, 3, pwb_buf, 7, true);
...
//B, 48*48*2 -> 48*48*64
    ...
    pw_conv_group(afm_1, rfm, wBUF1x1_A, 2);
    export_fm_full_withact(fm, 25729, rfm, 2, pwb_buf, 5, true);
...
//C, 48*48*64 -> 48*48*32
    ...
    export_fm_full_withact(fm, 23425, rfm, 1, pwb_buf, 7, true);
...
//D3, 48*48*128 -> 48*48*80
    ...
    export_fm_full_withact(fm, 41857, rfm, 2, pwb_buf, 7, true);
    {
...
//H3, 48*48*96 -> 48*48*96
    ...
    export_fm_full_withact(fm, 62593, rfm, 3, pwb_buf, 8, true);
