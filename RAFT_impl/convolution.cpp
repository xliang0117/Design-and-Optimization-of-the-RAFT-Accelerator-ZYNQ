    ...
    for (int row = 0; row < 50; row++)
    {
        for (int col = 0; col < 50; col++)
        {
            ...
            for (int c = 0; c < 32; c++)
            {
                ...
                RDT res = MAC9(
                    window_buffer[0][0][c], window_buffer[0][1][c], window_buffer[0][2][c],
                    window_buffer[1][0][c], window_buffer[1][1][c], window_buffer[1][2][c],
                    window_buffer[2][0][c], window_buffer[2][1][c], window_buffer[2][2][c],
                    wBUF3x3[0][0][c], wBUF3x3[0][1][c], wBUF3x3[0][2][c],
                    wBUF3x3[1][0][c], wBUF3x3[1][1][c], wBUF3x3[1][2][c],
                    wBUF3x3[2][0][c], wBUF3x3[2][1][c], wBUF3x3[2][2][c]);
